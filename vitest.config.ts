...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Scope to genuinely unit-testable modules: the pure scanner, checksum and
      // validation. The engine's DOM/stream-bound parts (download, ZipReader) are
      // exercised by the Playwright e2e suite instead.
      include: [
        'src/utils/fileValidation.ts',
        'src/utils/crc32.ts',
        'src/utils/zipScan.ts',
      ],
