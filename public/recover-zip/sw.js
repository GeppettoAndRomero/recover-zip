...
const PRECACHE_URLS = [
  '/recover-zip/',
  '/recover-zip/manifest.json',
  '/recover-zip/icon-192.png',
  '/recover-zip/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/recover-zip/manifest.json';
}
